...
#ifdef BOND_CLASS
// clang-format off
BondStyle(bpm/uFJC,BondBPMuFJC);
// clang-format on
#else

#ifndef LMP_BOND_BPM_uFJC_H
#define LMP_BOND_BPM_uFJC_H

#include "bond_bpm.h"

namespace LAMMPS_NS {

class BondBPMuFJC : public BondBPM {
 public:
  BondBPMuFJC(class LAMMPS *);
  ~BondBPMuFJC() override;
