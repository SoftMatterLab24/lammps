...
BondBPMuFJC::BondBPMuFJC(LAMMPS *_lmp) :
    BondBPM(_lmp), k0(nullptr), kappa(nullptr), fcrit(nullptr), gamma(nullptr), lamc(nullptr),
...
double BondBPMuFJC::store_bond(int n, int i, int j)
{
  int type;
...
void BondBPMuFJC::compute(int eflag, int vflag)
{
...
void BondBPMuFJC::coeff(int narg, char **arg)
{
...
void BondBPMuFJC::settings(int narg, char **arg)
{
...
void BondBPMuFJC::write_restart(FILE *fp)
{
...
void BondBPMuFJC::read_restart(FILE *fp)
{
...
void BondBPMuFJC::write_restart_settings(FILE *fp)
{
...
void BondBPMuFJC::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double BondBPMuFJC::single(int type, double rsq, int i, int j, double &fforce)
{
...
void BondBPMuFJC::null_table(Table *tb)
{
...
void BondBPMuFJC::free_table(Table *tb)
{
...
void BondBPMuFJC::read_table(Table *tb, char *file, char *keyword)
{
...
void BondBPMuFJC::bcast_table(Table *tb) // *UPDATED
{
